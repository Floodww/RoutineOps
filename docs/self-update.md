...
Актуально на 2026-07-15 (v2.4.3). Механизм реализован полностью (агент + сервер)
...
{
  "version":            "v2.4.3",
  "url":                "https://<SERVER_IP>/downloads/agent_darwin_arm64_v2.4.3",
...
os/arch/version — повторная публикация той же версии не падает).
