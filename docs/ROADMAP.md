...
Актуально для продукта 2.11.0 и выше; агент — 2.6.9 и выше в канале stable
(версионируются раздельно). В канале beta идёт агент 2.6.12: непрерывный режим обслуживания удалённого
стола, см. этап 2.
