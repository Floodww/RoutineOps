...
| Удаление ПО с устройства из интерфейса (селектор цели — из инвентаря сервера, метод снятия выбирает агент; приёмка на Windows пройдена) | ✅ (open-core с 13.08.2026) |
