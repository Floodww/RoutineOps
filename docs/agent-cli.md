...
Актуально на 2026-07-29 (агент 2.5.5). Набор флагов и env с 2.5.0 не менялся —
сверено диффом `cmd/agent`. Поведение: с 2.5.4/2.5.5 каталог (и файлы) mTLS-ключа
на Windows закрываются admin-only DACL при enroll и на старте службы.
